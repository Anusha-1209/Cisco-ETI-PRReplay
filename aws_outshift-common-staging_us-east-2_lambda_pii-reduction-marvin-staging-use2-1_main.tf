...
terraform {
  backend "s3" {
    ...
    key = "terraform-state/aws/outshift-common-staging/us-east-2/lambda/pii-reduction-marvin-staging-use2-1.tfstate"
...
module "lambda_function_container_image" {
  ...
  timeout = 180
  memory_size = 3008
  image_uri    = "626007623524.dkr.ecr.us-east-2.amazonaws.com/marvin/images/pii-service/server:2024-07-17-674d961"
  package_type = "Image"
