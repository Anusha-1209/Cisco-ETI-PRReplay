...
terraform {
  backend "s3" {
    ...
    key    = "terraform-state/aws/outshift-common-dev/us-east-2/vpc-peering/marvin-test-compute-to-data.tfstate"
    region = "us-east-2"
  }
}

locals {
  acceptor_vpc_name  = "marvin-test-use2-1"
  requestor_vpc_name = "marvin-dev-use2-data"
}
