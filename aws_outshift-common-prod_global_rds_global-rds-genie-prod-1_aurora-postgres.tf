terraform {
  backend "s3" {
    ...
    key     = "terraform-state/aws/outshift-common-dev/global/rds/global-rds-genie-prod-1.tfstate"     
    region  = "us-east-2"                                                                  
  }
}
...
module "rds_primary" {
  ...
  source            = "git::https://github.com/cisco-eti/sre-tf-module-aws-aurora-postgres?ref=fix-circular-dependency"
  vpc_name          = local.data_primary_vpc
  database_name     = "postgressql"
  db_instance_type  = "db.r5.xlarge"
  cluster_name      = "global-rds-genie-prod-use2-1"
  kms_key_id        = aws_kms_key.primary.arn
  master_username   = "root"
  secret_path       = "secret/prod/infra/aurora-pg/us-east-2/outshift-common-prod/global-rds-genie-prod-use2-1"
