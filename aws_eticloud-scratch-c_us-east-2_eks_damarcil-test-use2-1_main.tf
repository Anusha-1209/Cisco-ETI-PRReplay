terraform {
  backend "s3" {
    ...
    key             = "terraform-state/aws/eticloud-scratch-c/us-east-2/eks/damarcil-test-use1-1.tfstate" # UPDATE ME.
...
module "eks_all_in_one" {
  source            = "git::https://github.com/cisco-eti/sre-tf-module-eks-allinone.git?ref=0.0.7"
