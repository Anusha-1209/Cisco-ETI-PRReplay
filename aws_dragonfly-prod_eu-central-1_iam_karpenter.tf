...
# resource "aws_iam_policy" "aws_karpenter_controller_policy_eu" {
...
# resource "aws_iam_role" "aws_karpenter_controller_role_eu" {
...
# resource "aws_iam_role" "aws_karpenter_node_role_eu" {
...
# resource "aws_iam_role_policy_attachment" "aws_karpenter_controller_attachment_eu" {
#   role       = aws_iam_role.aws_karpenter_controller_role_eu.name
...
#   role       = aws_iam_role.aws_karpenter_node_role_eu.name
