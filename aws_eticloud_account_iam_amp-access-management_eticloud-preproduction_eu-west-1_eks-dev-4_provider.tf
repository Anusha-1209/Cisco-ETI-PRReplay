...
provider "aws" {
  access_key = data.vault_generic_secret.aws_infra_credential_preprod.data["AWS_ACCESS_KEY_ID"]
  secret_key = data.vault_generic_secret.aws_infra_credential_preprod.data["AWS_SECRET_ACCESS_KEY"]
...
data "vault_generic_secret" "aws_infra_credential_preprod" {
