terraform {
  backend "s3" {
    ...
    key     = "terraform-state/aws/cnapp-staging/eu-central-1/rds/rosey-staging-rds-euc1-1.tfstate"     
    region  = "us-east-2"                                                                  
  }
}
...
locals {
  ...
  rds_name         = "rosey-staging-rds-euc1-1"
}
...
module "rds" {
  ...
  secret_path       = "secret/eticcprod/infra/aurora-pg/eu-central-1/cnapp-staging/rosey-staging-rds-euc1-1"
