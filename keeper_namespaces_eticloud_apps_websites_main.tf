...
variable "venture_name" {
  type    = string
  default = "websites" # <-- requires updating
}
...
provider "vault" {
  address   = "https://keeper.cisco.com"
  namespace = "eticloud/apps/websites" # <-- requires updating
  alias     = "venture"
}
...
locals {
  policies = {
    ...
    "external-secrets-eks-common-dev-1"     = "policies/external-secrets-eks-common-dev-1.hcl",
    ...
    "external-secrets-staging-websites"     = "policies/external-secrets-staging-websites.hcl",
    "external-secrets"                      = "policies/external-secrets.hcl",
    "jenkins-dev-user"                      = "policies/jenkins-dev-user.hcl",
    "policy"                                = "policies/policy.hcl",
    "websites-admin"                        = "policies/websites-admin.hcl",
    "websites-dev-user"                     = "policies/websites-dev-user.hcl",
    "websites-prod-user"                    = "policies/websites-prod-user.hcl",
  }
}
