terraform {
  backend "s3" {
    ...
    key     = "terraform-state/aws/outshift-common-staging/us-east-2/rds/rds-common-stg-1.tfstate"     
    region  = "us-east-2"                                                                  
  }
}
...
locals {
  ...
  data_vpc         = "eks-common-stg-1-data"
  eks_vpc          = "eks-common-stg-1"
  rds_name         = "rds-common-stg-1"
}
...
module "rds" {
  ...
  secret_path       = "secret/eticcprod/infra/aurora-pg/us-east-2/outshift-common-staging/rds-common-stg-1"
