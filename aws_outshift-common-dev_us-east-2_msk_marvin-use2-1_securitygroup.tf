...
resource "aws_security_group" "marvin-dev-use2-1-msk" {
  name        = "marvin-dev-use2-1-msk-default"
  description = "marvin-dev-use2-1-msk MSK cluster default security group"
