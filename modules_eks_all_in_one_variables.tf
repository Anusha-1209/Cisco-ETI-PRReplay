...
variable "bastion_additional_security_groups" {
  description = "Additional security groups to attach to the bastion host"
  type        = list(string)
  default     = []
}
...
variable "create_cluster_addons" {
  description = "Determines whether to create the cluster addons"
  type        = bool
  default     = true
}
...
variable "additional_aws_auth_configmap_roles" {
  description = "List of additional role maps to add to the aws-auth configmap"
  type        = list(any)
  default     = []
}
...
variable "create_kms" {
  description = "Controls if KMS should be created (affects EKS Creation)"
  type        = bool
  default     = true
}
...
variable "create_ng_key_pair" {
  description = "Determines whether a key pair will be created for the node group"
  type        = bool
  default     = true
}
...
################################################################################
# EKS Node Group User Data
################################################################################

variable "create_user_data" {
  description = "Determines whether user data will be created for the node group"
  type        = bool
  default     = true
}
...
variable cluster_os {
  description = "EKS Node Cluster OS"
  type        = string
  default     = "Ubuntu20"
}
