...
resource "aws_msk_scram_secret_association" "msk_auth_credentials" {
  cluster_arn = aws_msk_cluster.marvin-staging-1-msk.arn
  secret_arn_list = [
...
resource "aws_msk_cluster" "marvin-staging-1-msk" {
  cluster_name           = "marvin-staging-1-msk"
