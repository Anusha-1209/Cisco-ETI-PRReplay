terraform {
  backend "s3" {
    ...
    key    = "terraform-state/vpc/us-east-2/motific-dev-use2-data-vpc.tfstate"
    region = "us-east-2"
  }
}
...
provider "aws" {
  ...
  default_tags {
    tags = {
      ApplicationName    = "motific-dev-use2-data-vpc"
...
module "vpc" {
  ...
  vpc_name                        = "motific-dev-use2-data"
  cluster_name                    = "motific-dev-use2-data"
