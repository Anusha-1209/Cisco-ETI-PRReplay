terraform {
  backend "s3" {
    ...
    key    = "terraform-state/aws-apisec-staging/elasticache/us-east-2/redis-apisec-staging-1.tfstate"
    region = "us-east-2"
  }
}
...
locals {
  ...
  subnet_group_name    = "redis-apisec-staging-1-vpc-ec-subnet-group"
  elasticache_name     = "redis-apisec-staging-1"
  redis_vpc_name       = "redis-apisec-staging-1-vpc"
...
resource "aws_security_group" "redis_security_group" {
  name = "redis-apisec-staging-1-sg"
