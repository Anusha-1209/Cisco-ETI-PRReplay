terraform {
  ...
  backend "s3" {
    ...
    key            = "terraform-state/s3/eu-west-1/harbor-gbear-dev.tfstate"
    region         = "us-east-2"
...
resource "aws_s3_bucket" "eti-harbor-gbear-dev" {
  bucket = "cisco-eti-harbor-gbear-dev"
...
resource "aws_s3_bucket_server_side_encryption_configuration" "this" {
  bucket = aws_s3_bucket.eti-harbor-gbear-dev.id
  rule {
