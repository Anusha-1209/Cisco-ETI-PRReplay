...
terraform {
  backend "s3" {
    ...
    key    = "terraform-state/vpc-peering/us-east-2/rds-apisec-staging-1-apisec-staging-1/rds-apisec-staging-1-apisec-staging-1.tfstate"
    region = "us-east-2"
  }
}

locals {
  acceptor_vpc_name  = "rds-apisec-staging-1-vpc"
