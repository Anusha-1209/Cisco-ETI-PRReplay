...
terraform {
  backend "s3" {
    ...
    key    = "terraform-state/vpc-peering/us-east-2/rds-apisec-prod-1-apisec-prod-1/rds-apisec-prod-1-apisec-prod-1.tfstate"
    region = "us-east-2"
  }
}

locals {
  acceptor_vpc_name  = "rds-apisec-prod-1-vpc"
