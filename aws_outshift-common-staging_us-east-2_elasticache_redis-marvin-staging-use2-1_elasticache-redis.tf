terraform {
  backend "s3" {
    ...
    key    = "terraform-state/outshift-common-staging/elasticache/us-east-2/redis-marvin-staging-use2-1.tfstate"
    region = "us-east-2"
  }
}
...
resource "aws_security_group" "redis_security_group" {
  name = "redis-marvin-staging-use2-1-sg"
...
resource "aws_elasticache_replication_group" "redis-marvin-staging-use2-1" {
