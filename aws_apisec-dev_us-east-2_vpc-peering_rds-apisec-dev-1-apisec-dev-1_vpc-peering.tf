...
terraform {
  backend "s3" {
    ...
    key    = "terraform-state/vpc-peering/us-east-2/rds-apisec-dev-1-apisec-dev-1/rds-apisec-dev-1-apisec-dev-1.tfstate"
    region = "us-east-2"
  }
}

locals {
  acceptor_vpc_name  = "apisec-dev-1-vpc"
  requestor_vpc_name = "rds-apisec-dev-1-vpc"
}
