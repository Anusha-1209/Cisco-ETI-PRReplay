terraform {
  backend "s3" {
    ...
    key     = "terraform-state/aws/eticloud/global/rds/global-rds-iam-prod-1.tfstate"     
    region  = "us-east-2"                                                                  
  }
}
...
module "rds_primary" {
  ...
  cluster_name      = "global-rds-iam-prod-use2-1"
  kms_key_id        = aws_kms_key.primary.arn
  master_username   = "root"
  secret_path       = "secret/prod/infra/aurora-pg/us-east-2/outshift-common-prod/global-rds-iam-prod-use2-1"
...
module "rds_secondary" {
  ...
  # instances                 = {}
  cluster_name              = "global-rds-iam-prod-usw2-1"
