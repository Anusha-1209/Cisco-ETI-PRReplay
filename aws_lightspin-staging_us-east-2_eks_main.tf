terraform {
  backend "s3" {
    ...
    key = "terraform-state/aws/lightspin-staging/us-east-2/eks/lightspin-staging-use2-1.tfstate"# UPDATE ME.
...
module "eks_all_in_one" {
  source           = "git::https://github.com/cisco-eti/sre-tf-module-eks-allinone.git?ref=0.5.6"
