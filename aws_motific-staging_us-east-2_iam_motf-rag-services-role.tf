    ...
    Statement = [
      {
        ...
        Condition = {
          StringEquals = {
            ...
            "oidc.eks.us-east-2.amazonaws.com/id/E44B0829BBFA73125E1843A705525B20:sub" : "system:serviceaccount:vowel-system:rag-acquisition-sa"
          }
        }
      },
      {
        ...
        Condition = {
          StringEquals = {
            "oidc.eks.us-east-2.amazonaws.com/id/E44B0829BBFA73125E1843A705525B20:aud" : "sts.amazonaws.com",
            "oidc.eks.us-east-2.amazonaws.com/id/E44B0829BBFA73125E1843A705525B20:sub" : "system:serviceaccount:vowel-system:rag-inference-sa"
          }
        }
      },
      {
        ...
        Condition = {
          StringEquals = {
            "oidc.eks.us-east-2.amazonaws.com/id/E44B0829BBFA73125E1843A705525B20:aud" : "sts.amazonaws.com",
            "oidc.eks.us-east-2.amazonaws.com/id/E44B0829BBFA73125E1843A705525B20:sub" : "system:serviceaccount:vowel-system:rag-ingestion-manager-sa"
          }
        }
      }
    ]
