terraform {
  backend "s3" {
    ...
    key    = "terraform-state/outshift-common-prod/elasticache/us-east-2/redis-marvin-prod-use2-1.tfstate"
    region = "us-east-2"
  }
}
...
locals {
  ...
  subnet_group_name    = "marvin-prod-use2-data-ec-subnet-group"
  elasticache_name     = "marvin-redis-prod-use2-1"
  redis_vpc_name   = "marvin-prod-use2-data"
  eks_cluster_vpc_name = "marvin-prod-use2-1"
}
...
resource "aws_security_group" "redis_security_group" {
  name = "redis-marvin-prod-use2-1-sg"
...
resource "aws_elasticache_replication_group" "redis-marvin-prod-use2-1" {
