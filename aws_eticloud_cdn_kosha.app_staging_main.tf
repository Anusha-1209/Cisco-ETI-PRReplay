module "staging-cloudfront" {
  ...
  version                       = "3.2.1"
  aliases                       = ["staging.kosha.app"]
  comment                       = "staging.kosha.app"
  enabled                       = true
  ...
  origin = {
    a = {
      ...
      domain_name         = "kosha-blue-a.staging.kosha.app"
      origin_id           = "origin_a"
    ...
    d = {
      connection_attempts = 3
      connection_timeout  = 10
      domain_name         = "kosha-blue-b.staging.kosha.app"
      origin_id           = "origin_b"
...
module "acm" {
  ...
  subject_alternative_names = ["staging.kosha.app"]
  tags = {
    DataClassification = var.staging_tag_data_classification
    DataTaxonomy       = var.staging_tag_data_taxonomy
    CiscoMailAlias     = var.staging_tag_cisco_mail_alias
