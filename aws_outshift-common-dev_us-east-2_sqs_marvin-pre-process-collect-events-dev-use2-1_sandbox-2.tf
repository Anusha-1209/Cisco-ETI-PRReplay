...
resource "aws_lambda_event_source_mapping" "pii-reduction-marvin-sandbox-2-use2-1-source-mapping" {
  event_source_arn = aws_sqs_queue.marvin-pre-process-collect-events-dev-sandbox-2-use2-1.arn
