...
terraform {
  backend "s3" {
    ...
    key    = "terraform-state/aws/outshift-common-prod/us-east-2/vpc-peering/marvin-prod-compute-to-data.tfstate"
    region = "us-east-2"
  }
}

locals {
  acceptor_vpc_name  = "marvin-prod-euc1-1"
  requestor_vpc_name = "marvin-prod-euc1-data"
}
