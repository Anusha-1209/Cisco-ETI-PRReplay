terraform {
  ...
  backend "s3" {
    ...
    key            = "backend/sre/demo-bucket-dev.tfstate"
    region         = "us-east-2"
...
resource "aws_s3_bucket" "sre-demo-bucket-dev" {
  bucket = "sre-demo-bucket-dev"
  acl    = "private"
  ...
  tags = {
    Name               = "sre-demo-bucket-dev"
    ApplicationName    = "DemoApps"
    Environment        = "NonProd"
