...
variable "venture_name" {
  type    = string
  default = "interns" # <-- requires updating
}
...
provider "vault" {
  address   = "https://keeper.cisco.com"
  namespace = "eticloud/apps/interns" # <-- requires updating
  alias     = "venture"
}
...
locals {
  policies = {
    ...
    "external-secrets-backstage01"          = "policies/external-secrets-backstage01.hcl",
  }
}
