terraform {
  backend "s3" {
    ...
    key     = "terraform-state/aws/eticloud/us-east-2/rds/rds-common-prod-1.tfstate"     
    region  = "us-east-2"                                                                  
  }
}
...
module "rds" {
  ...
  secret_path       = "secret/eticcprod/infra/aurora-pg/us-east-2/eticloud/rds-common-prod-1"
