terraform {
  backend "s3" {
    ...
    key    = "terraform-state/vpc/us-east-2/comn-dev-use2-1-data.tfstate"
    region = "us-east-2"
  }
}
...
provider "aws" {
  ...
  default_tags {
    tags = {
      ApplicationName    = "comn-dev-use2-1-data-vpc"
...
module "vpc" {
  ...
  vpc_name                        = "comn-dev-use2-1-data"
  cluster_name                    = "comn-dev-use2-1-data"
