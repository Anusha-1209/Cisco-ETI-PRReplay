...
variable "venture_name" {
  type    = string
  default = "lightspin" # <-- requires updating
}
...
provider "vault" {
  address   = "https://keeper.cisco.com"
  namespace = "eticloud/apps/lightspin" # <-- requires updating
  alias     = "venture"
}
...
resource "vault_jwt_auth_backend_role" "developer" {
  ...
  bound_audiences              = [var.oidc_client_id]
  bound_claims = {
    memberof = "CN=eti-${var.venture_name}-rnd-all,OU=Cisco Groups,DC=cisco,DC=com"
  }
  disable_bound_claims_parsing = true
  bound_claims_type            = "string"
  claim_mappings = {
...
# List, create, update, and delete key/value secrets
path "secret/lightspin-dev-1/*"
{
  capabilities = ["create", "read", "update", "delete", "list", "sudo"]
}

path "secret/data/lightspin-dev-1/*"
{
  capabilities = ["create", "read", "update", "delete", "list", "sudo"]
}
...
# List, create, update, and delete key/value secrets
path "secret/lightspin-staging-1/*"
{
  capabilities = ["create", "read", "update", "delete", "list", "sudo"]
}
path "secret/data/lightspin-staging-1/*"
{
  capabilities = ["create", "read", "update", "delete", "list", "sudo"]
}

# List, create, update, and delete key/value secrets
path "secret/lightspin-prod-1/*"
{
  capabilities = ["create", "read", "update", "delete", "list", "sudo"]
}
path "secret/data/lightspin-prod-1/*"
{
  capabilities = ["create", "read", "update", "delete", "list", "sudo"]
}
