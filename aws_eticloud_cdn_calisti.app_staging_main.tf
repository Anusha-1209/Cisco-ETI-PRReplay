module "staging-cloudfront" {
  ...
  version                       = "2.6.0"
  aliases                       = ["staging.calisti.app"]
  comment                       = "staging.calisit.app"
  enabled                       = true
  ...
  origin = {
    a = {
      ...
      domain_name         = "staging-blue-a.calisti.app"
      origin_id           = "origin_a"
    ...
    d = {
      connection_attempts = 3
      connection_timeout  = 10
      domain_name         = "staging-blue-b.calisti.app"
      origin_id           = "origin_b"
...
module "acm" {
  ...
  subject_alternative_names = ["staging.calisti.app"]
  tags = {
    DataClassification = var.staging_tag_data_classification
    DataTaxonomy       = var.staging_tag_data_taxonomy
    CiscoMailAlias     = var.staging_tag_cisco_mail_alias
