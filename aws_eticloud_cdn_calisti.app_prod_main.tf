module "prod-cloudfront" {
  ...
  version                       = "2.6.0"
  aliases                       = ["prod.calisti.app","calisti.app","www.calisti.app"]
  comment                       = "prod.calisit.app"
  enabled                       = true
  ...
  origin = {
    a = {
      ...
      domain_name         = "prod-blue-a.calisti.app"
      origin_id           = "origin_a"
    ...
    d = {
      connection_attempts = 3
      connection_timeout  = 10
      domain_name         = "prod-blue-b.calisti.app"
      origin_id           = "origin_b"
...
module "acm" {
  ...
  version = "3.0.0"
  domain_name = "calisti.app"
  zone_id     = data.aws_route53_zone.this.id
  subject_alternative_names = ["prod.calisti.app","calisti.app","www.calisti.app"]
  tags = {
    DataClassification = var.prod_tag_data_classification
    DataTaxonomy       = var.prod_tag_data_taxonomy
    CiscoMailAlias     = var.prod_tag_cisco_mail_alias
