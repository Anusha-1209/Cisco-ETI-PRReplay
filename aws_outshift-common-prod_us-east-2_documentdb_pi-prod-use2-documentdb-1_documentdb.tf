...
terraform {
  backend "s3" {
    ...
    key     = "terraform-state/aws/outshift-common-prod/us-east-2/documentdb/pi-prod-use2-documentdb-1.tfstate"  # UPDATE ME.
...
resource "aws_docdb_cluster" "docdb" {
  cluster_identifier              = "pi-prod-use2-documentdb-1"
...
resource "aws_docdb_cluster_instance" "docdb_instances" {
  count              = 2
  identifier         = "pi-prod-use2-documentdb-1-${count.index}"
