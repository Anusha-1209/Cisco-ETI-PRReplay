...
resource "aws_glue_connection" "rds-marvin-sandbox-2-connection" {
  name = "rds-marvin-sandbox-2-connection"

  connection_properties = {
    JDBC_CONNECTION_URL  = "jdbc:postgresql://${data.aws_rds_cluster.marvin-dev-use2-1.endpoint}:5432/marvin-sandbox-2"
