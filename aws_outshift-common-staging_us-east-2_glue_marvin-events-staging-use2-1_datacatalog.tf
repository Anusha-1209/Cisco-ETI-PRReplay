...
resource "aws_glue_connection" "rds-marvin-connection" {
  ...
  connection_properties = {
    JDBC_CONNECTION_URL  = "jdbc:postgresql://${data.aws_rds_cluster.marvin-staging-use2-1.endpoint}/marvin"
  ...
  physical_connection_requirements {
    ...
    security_group_id_list = data.aws_rds_cluster.marvin-staging-use2-1.vpc_security_group_ids
