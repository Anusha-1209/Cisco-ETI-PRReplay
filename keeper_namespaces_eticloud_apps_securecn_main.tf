...
variable "venture_name" {
  type    = string
  default = "securecn" # <-- requires updating
}
...
provider "vault" {
  address   = "https://keeper.cisco.com"
  namespace = "eticloud/apps/securecn" # <-- requires updating
  alias     = "venture"
}
...
locals {
  policies = {
    ...
    "external-secrets-cwpp-dev-1"           = "policies/external-secrets-cwpp-dev-1.hcl",
    "external-secrets-cwpp-pr"              = "policies/external-secrets-cwpp-pr.hcl",
    "external-secrets-cwpp-staging-1"       = "policies/external-secrets-cwpp-staging-1.hcl",
    "external-secrets-cwpp-prod"            = "policies/external-secrets-cwpp-prod.hcl",
    "external-secrets-cwpp-prod-us"         = "policies/external-secrets-cwpp-prod-us.hcl",
