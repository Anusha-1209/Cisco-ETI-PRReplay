...
terraform {
  backend "s3" {
    ...
    key    = "terraform-state/ec2/us-east-2/cisco-research-9.tfstate" # Note the path here. It should match the patten terraform_state/<service>/<region>/<name>.tfstate
...
module "ec2" {
  ...
  ec2_name                        = "cisco-research-9" # The name of the instance(s) to be created. Will be appended with a number.
  ...
  tag_application_name            = "cisco-research-9"
