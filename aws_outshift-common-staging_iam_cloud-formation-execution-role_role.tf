...
data "aws_iam_policy_document" "cloudformation_execution_role_policy" {
  ...
  statement {
    ...
    resources = [
      "arn:aws:lambda:*:${data.aws_caller_identity.current.account_id}:function:${local.lambda_application}-*",
    ]
    effect = "Allow"
  }
  ...
  statement {
    ...
    resources = [
      "arn:aws:logs:*:${data.aws_caller_identity.current.account_id}:log-group:/aws/lambda/${local.lambda_application}-*",
    ]
    effect = "Allow"
  }
  ...
  statement {
    ...
    resources = [
      "arn:aws:dynamodb:*:${data.aws_caller_identity.current.account_id}:table/${local.lambda_application}-*",
      "arn:aws:dynamodb:*:${data.aws_caller_identity.current.account_id}:global-table/${local.lambda_application}-*",    ]
