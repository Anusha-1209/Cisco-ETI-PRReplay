...
resource "aws_glue_catalog_table" "aws_glue_catalog_marvin_sandbox_0_table" {
  name          = "events_dev_sandbox_0_use2_1"
  ...
  storage_descriptor {
    location      = "s3://msk-connect-marvin-dev-use2-1/topics/events-sandbox-0/"
...
resource "aws_glue_connection" "rds-marvin-sandbox-0-connection" {
  ...
  connection_properties = {
    JDBC_CONNECTION_URL  = "jdbc:postgresql://${data.aws_rds_cluster.marvin-dev-use2-1.endpoint}/marvin-sandbox-0"
