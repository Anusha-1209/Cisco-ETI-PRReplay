...
module "lambda_function_container_image" {
  ...
  timeout = 180
  memory_size = 3008
  image_uri    = "626007623524.dkr.ecr.eu-central-1.amazonaws.com/marvin/images/pii-service/server:2024-07-15-82da594"
  package_type = "Image"
  ...
  docker_additional_options = [
    "-e", "SQS_URL='https://sqs.eu-central-1.amazonaws.com/637423477129/marvin-collect-events-prod-ecu1-1'"
  ]
}
