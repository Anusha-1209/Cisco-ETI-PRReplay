...
terraform {
  backend "s3" {
    ...
    key = "terraform-state/aws/outshift-common-prod/us-east-2/lambda/pii-reduction-marvin-prod-euc1-1.tfstate"
...
locals {
  cluster_name = "marvin-prod-ecu1-1" # The name of the associated EKS cluster. Must be updated
...
module "lambda_function_container_image" {
  ...
  timeout = 180
  memory_size = 3008
  image_uri    = "626007623524.dkr.ecr.eu-central-1.amazonaws.com/marvin/images/pii-service/server:2024-07-17-674d961"
  package_type = "Image"
  ...
  docker_additional_options = [
    "-e", "SQS_URL='https://sqs.eu-central-1.amazonaws.com/058264538874/marvin-collect-events-prod-ecu1-1'"
  ]
}
