...
terraform {
  backend "s3" {
    ...
    key    = "terraform-state/vpc-peering/eu-central-1/redis-apisec-prod-eu-1-apisec-prod-eu-1/redis-apisec-prod-eu-1-apisec-prod-eu-1.tfstate"
    region = "us-east-2"
  }
}

locals {
  acceptor_vpc_name  = "redis-apisec-prod-eu-1-vpc"
  requestor_vpc_name = "apisec-prod-eu-1-vpc"
}
