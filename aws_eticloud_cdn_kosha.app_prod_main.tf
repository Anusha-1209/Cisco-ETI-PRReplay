module "prod-cloudfront" {
  ...
  version                       = "2.6.0"
  aliases                       = ["prod.kosha.app","kosha.app","www.kosha.app"]
  comment                       = "prod.kosha.app"
  enabled                       = true
  ...
  origin = {
    a = {
      ...
      domain_name         = "prod-blue-a.kosha.app"
      origin_id           = "origin_a"
    ...
    d = {
      connection_attempts = 3
      connection_timeout  = 10
      domain_name         = "prod-blue-b.kosha.app"
      origin_id           = "origin_b"
...
module "acm" {
  ...
  version = "3.0.0"
  domain_name = "kosha.app"
  zone_id     = data.aws_route53_zone.this.id
  subject_alternative_names = ["prod.kosha.app","kosha.app","www.kosha.app"]
  tags = {
    DataClassification = var.prod_tag_data_classification
    DataTaxonomy       = var.prod_tag_data_taxonomy
    CiscoMailAlias     = var.prod_tag_cisco_mail_alias
